                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">>Face Threading Booking</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="comment-reply-box">
                                <h5 class="title">Face Threading Booking</h5>
                                    ...
                                    <form action="#" class="sidebar-find-pets">
                                        ...
                                        <div class="row">
                                            ...
                                            <select  class="selected"  id="category"  >
                                                <option data-display>List Of Services</option>
                                                <option value="face">Full Face Threading (RS-1000.00)</option>
                                                <option value="U_lip">Upper lip Threading (RS-500.00)</option>
                                                <option value="eyebrows">Eyebrows Shaping (RS-300.00)</option>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog.php"><img src="/../Beauty/img/blog/blog_post_thumb01.jpg" alt=""></a>
                                                </div>
                                                <div class="rc-post-content">
                                                    <h5 class="title"><a href="blog-details.html">Your face needs the best treatment</a></h5>
                                            ...
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog-details.html"><img src="/../Beauty/img/blog/blog_post_thumb09.jpeg" alt=""></a>
                                                </div>
                                                <div class="rc-post-content">
                                                    <h5 class="title"><a href="blog.php">You need the best treatments to keep you beautiful</a></h5>
                                                    <div class="rc-post-meta">
                                                        <ul>
                                                            <li><i class="far fa-calendar-alt"></i> may 15, 2024</li>
                                                            <li>By <a href="#">Admin</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
