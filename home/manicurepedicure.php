    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Manicure & Pedicure Services</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="comment-reply-box">
                                <h5 class="title">Manicure & Pedicure Services</h5>
                                ...
                                <div class="widget breeder-widget">
                                    ...
                                    <form action="#" class="sidebar-find-pets">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-grp">
                                                <select class="selected" id="category"  >
                                                    <option data-display>LIST OF MANICURES</option>
                                                    <option value="Emani">Eppress Manicure (RS-3800.00)</option>
                                                    <option value="Smani">Signature Manicure (RS-5000.00)</option>
                                                    <option value="Pmani">Pomper Manicure (RS-6000.00)</option>
                                                    <option value="Epedi">Eppress Pedicure (RS-4800.00)</option>
                                                    <option value="Spedi">Signature Pedicure (RS-6000.00)</option>
                                                    <option value="Ppedi">Pomper Pedicure (RS-8000.00)</option> 
                                                </select>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog.php"><img src="/../Beauty/img/blog/blog_post_thumb08.jpg" alt=""></a>
                                                </div>
                                                <div class="rc-post-content">
                                                    <h5 class="title"><a href="blog-details.html">Keep your limbs beautiful</a></h5>
                                                    <div class="rc-post-meta">
                                                        <ul>
                                                            <li><i class="far fa-calendar-alt"></i> April 15, 2024</li>
                                            ...
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog-details.html"><img src="/../Beauty/img/blog/blog_post_thumb05.jpg" alt=""></a>
                                                </div>
                                                <div class="rc-post-content">
                                                    <h5 class="title"><a href="blog.php">You need the best treatments to keep you beautiful</a></h5>
                                                    <div class="rc-post-meta">
                                                        <ul>
                                                            <li><i class="far fa-calendar-alt"></i> March 25, 2024</li>
                                                            <li>By <a href="#">Admin</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
        ...
        <script>
            $(document).ready(function () {
                $.ajax({
                    type: "post",
                    url: "database/ajaxtmanicurepedicure.php",
                    data: {
                        getDates : "yes",
                    },
                    dataType: "text",
