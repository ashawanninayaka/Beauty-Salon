<?php
    ...
    if(isset($_POST['getDates'])){
        ...
        if($type == "grooming"){
            $query = mysqli_query($con, "INSERT INTO bookingdressing(category, age, date, time, serviceType, user) VALUES('".$category."', ".$age.", '".$date."', '".$time."', 'C', '".$id."')");
            echo "success";
        }
        ...
        $query = mysqli_query($con, "SELECT * FROM bookingdressing WHERE date='".$date."' ");
