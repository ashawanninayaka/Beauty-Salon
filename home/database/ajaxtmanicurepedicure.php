<?php
    ...
    if(isset($_POST['getDates'])){
        ...
        if($type == "testing"){
            $query = mysqli_query($con, "INSERT INTO bookingmanicurepedicure(category, age, date, time, serviceType, user) VALUES('".$category."', ".$age.", '".$date."', '".$time."', 'D', '".$id."')");
            echo "success";
        }
        ...
        $query = mysqli_query($con, "SELECT * FROM bookingmanicurepedicure WHERE date='".$date."' ");
