<?php
    ...
    if(isset($_POST['getDates'])){
        ...
        if($type == "Other"){
            $query = mysqli_query($con, "INSERT INTO bookinghaircutting(category, age, date, time, serviceType, user) VALUES('".$category."', ".$age.", '".$date."', '".$time."', 'B', '".$id."')");
            echo "success";
        }
        ...
        $query = mysqli_query($con, "SELECT * FROM bookinghaircutting WHERE date='".$date."' ");
