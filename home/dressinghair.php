                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Dressing Hair Makeup</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="comment-reply-box">
                                <h5 class="title">Dressing Hair Makeup</h5>
                                ...
                                <div class="widget breeder-widget">
                                    ...
                                    <form action="#" class="sidebar-find-pets">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-grp">
                                                <select name="Slist" class="selected" name="Slist" id="category"  >
                                                    <option data-display>List Of Services</option>
                                                    <option value="makeup">Makeup (60min_RS-5000.00)</option>
                                                    <option value="saree">Saree droping (RS-3000.00)</option>
                                                    <option value="full_d">Full Dressing (2hr_RS-10000.00)</option>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog.php"><img src="/../Beauty/img/blog/blog_post_thumb13.jpg" alt=""></a>
                                                </div>
                                                <div class="rc-post-content">
                                                    <h5 class="title"><a href="blog-details.html">Makeup enhances your beauty</a></h5>
                                            ...
                                            <li>
                                                <div class="rc-post-thumb">
                                                    <a href="blog-details.html"><img src="/../Beauty/img/blog/blog_post_thumb04.jpg" alt=""></a>
                                                </div>
                                                <div class="rc-post-content">
                                                    <h5 class="title"><a href="blog.php">You need the best treatments to keep you beautiful</a></h5>
                                                    <div class="rc-post-meta">
                                                        <ul>
                                                            <li><i class="far fa-calendar-alt"></i> March 02, 2024</li>
                                                            <li>By <a href="#">Admin</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
